...
namespace NewsManagement.Migrations
{
    ...
    [Migration("20240911071735_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsManagement.Entities.Galleries.GalleryImage", b =>
                {
            ...
            modelBuilder.Entity("NewsManagement.Entities.ListableContentRelations.ListableContentCategory", b =>
                {
            ...
            modelBuilder.Entity("NewsManagement.Entities.ListableContentRelations.ListableContentCity", b =>
                {
                    b.Property<int>("ListableContentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NewsManagement.Entities.ListableContentRelations.ListableContentRelation", b =>
                {
                    b.Property<int>("ListableContentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NewsManagement.Entities.ListableContentRelations.ListableContentTag", b =>
                {
                    b.Property<int>("ListableContentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NewsManagement.Entities.Newses.NewsDetailImage", b =>
                {
            ...
            modelBuilder.Entity("NewsManagement.Entities.Galleries.GalleryImage", b =>
                {
                    b.HasOne("NewsManagement.Entities.Galleries.Gallery", "Gallery")
            ...
            modelBuilder.Entity("NewsManagement.Entities.ListableContentRelations.ListableContentRelation", b =>
                {
                    ...
                    b.HasOne("NewsManagement.Entities.ListableContents.ListableContent", "RelatedListableContent")
                        .WithMany()
            ...
            modelBuilder.Entity("NewsManagement.Entities.Newses.NewsDetailImage", b =>
                {
                    b.HasOne("NewsManagement.Entities.Newses.News", "News")
            ...
            modelBuilder.Entity("NewsManagement.Entities.Galleries.Gallery", b =>
                {
                    b.HasOne("NewsManagement.Entities.ListableContents.ListableContent", null)
                        .WithOne()
                        .HasForeignKey("NewsManagement.Entities.Galleries.Gallery", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("NewsManagement.Entities.Newses.News", b =>
                {
                    b.HasOne("NewsManagement.Entities.ListableContents.ListableContent", null)
                        .WithOne()
                        .HasForeignKey("NewsManagement.Entities.Newses.News", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("NewsManagement.Entities.Videos.Video", b =>
                {
                    b.HasOne("NewsManagement.Entities.ListableContents.ListableContent", null)
                        .WithOne()
                        .HasForeignKey("NewsManagement.Entities.Videos.Video", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
