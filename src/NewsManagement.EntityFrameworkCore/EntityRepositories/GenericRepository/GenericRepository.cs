...
namespace NewsManagement.EntityRepositories.GenericRepository
{
  public class GenericRepository<T> : EfCoreRepository<NewsManagementDbContext, T, int>, IGenericRepository<T>
    where T : ListableContent, new()
  {

    public GenericRepository(IDbContextProvider<NewsManagementDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
